...
class SpeedTrap(Packet):
    _fields_ = [
        ...
        ("m_overall_fastest_in_session", ctypes.c_uint8),    #  Overall fastest speed in session = 1, otherwise 0
        ("m_driver_fastest_in_session", ctypes.c_uint8),    #  Fastest speed for driver in session = 1, otherwise 0
    ]
